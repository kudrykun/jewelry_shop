class SaleSizesController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @sale_size.save
        format.html { redirect_to @sale_size, notice: 'Sale size was successfully created.' }
  ...
  def update
    respond_to do |format|
      if @sale_size.update(sale_size_params)
        format.html { redirect_to @sale_size, notice: 'Sale size was successfully updated.' }
  ...
  def destroy
    @sale_size.destroy
    respond_to do |format|
      format.html { redirect_to sale_sizes_url, notice: 'Sale size was successfully destroyed.' }
