class Admin::MetalTypesController < Admin::AdminController
  ...
  def create
    ...
    respond_to do |format|
      if @metal_type.save
        format.html { redirect_to admin_metal_type_path(@metal_type), notice: 'Данный тип металла был успешно создан.' }
  ...
  def update
    respond_to do |format|
      if @metal_type.update(metal_type_params)
        format.html { redirect_to admin_metal_type_path(@metal_type), notice: 'Данный тип металла был успешно обновлен.' }
  ...
  def destroy
    @metal_type.destroy
    respond_to do |format|
      format.html { redirect_to admin_metal_types_url, notice: 'Данный тип металла был успешно удален.' }
